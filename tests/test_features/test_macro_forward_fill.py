"""Test forward-fill CPI/Unemployment (A36-A38) — docs/05_test_plan.md mục 1.

Bối cảnh: features.csv thật thiếu CPI/Unemployment đúng 13 tuần cuối test_window
ở mọi Store, do độ trễ công bố macro index — xem docs/00_decisions.md
[2026-08-19] "Xử lý CPI/Unemployment missing ở đuôi test_window".
"""
